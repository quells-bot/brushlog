...
const layout = [
	...
	// Lower arch — same path: outer left→front→right, biting right, inner right→front→left, biting left.
	{
		...
		surface: 'Outer',
		label: 'Outer left',
		hint: 'Cheek side of your lower left teeth'
	},
	{
		id: 'l-out-f',
		arch: 'Lower',
		surface: 'Outer',
		label: 'Outer front',
		hint: 'Cheek side of your lower front teeth'
	},
	{
		id: 'l-out-r',
		arch: 'Lower',
	...
	},
	{
		...
		surface: 'Inner',
		label: 'Inner right',
		hint: 'Tongue side of your lower right teeth'
	},
	{
		id: 'l-in-f',
		arch: 'Lower',
		surface: 'Inner',
		label: 'Inner front',
		hint: 'Tongue side of your lower front teeth'
	},
	{
		id: 'l-in-l',
		arch: 'Lower',
		surface: 'Inner',
		label: 'Inner left',
		hint: 'Tongue side of your lower left teeth'
	},
	{
		id: 'l-bite-l',
		arch: 'Lower',
